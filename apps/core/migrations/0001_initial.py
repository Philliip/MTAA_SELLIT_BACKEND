    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip', models.CharField(max_length=10, verbose_name='city_zip')),
            ],
            options={
                'db_table': 'cities',
                'default_permissions': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('longitude', models.CharField(max_length=255, verbose_name='location_message')),
                ('latitude', models.CharField(max_length=255, verbose_name='coordinates_message')),
            ],
            options={
                'db_table': 'locations',
                'default_permissions': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('content', models.CharField(max_length=200, null=True, verbose_name='message_content')),
